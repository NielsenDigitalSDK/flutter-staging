...
class _HomePageState extends State<HomePage> {
  ...
  Map<String, String> appInfo = (Platform.isAndroid)
      ? {
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  final appInfoData =
                      await NielsenFlutterPluginPlatform.instance.getAppInfo();
                  final result =
                      await platform?.createInstance(jsonEncode(appInfoData));
