...
in the front facing package `nielsen_flutter_plugin` example. 
...
```sh
cd nielsen_flutter_plugin/example
fluttium test flows/test_platform_name.yaml
```

[coverage_badge]: nielsen_flutter_plugin/coverage_badge.svg
...
[fluttium_install]: https://fluttium.dev/docs/getting-started/installing-cli# flutter-test
