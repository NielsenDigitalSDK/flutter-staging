...
const String appName = 'Flutter Video Playerr';
const String openVideo = 'Open Video Player';
const String infoScreen = 'Go to info screen';


// method channels for android and iOS
const String iOSMethodChannel = 'NielsenIOSAppSDK';
const String androidMethodChannel = 'NielsenAndroidAppSDK';
...
const String firstPartyId = 'firstPartyId';
